  ...
  return <section className="section-hero py-20 lg:py-32">
      <div className="container">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Headline */}
          <h1 className="text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl lg:text-6xl mb-6 animate-slide-up">Compliance&nbsp;Acknowledgments<br /><span className="text-accent font-bold">Simplified</span></h1>
