  ...
  return <section id="features" className="py-20 lg:py-32 bg-card">
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">From policy acknowledgments to audit exports, Attestly handles it all so you can focus on your business. Works for employees, contractors, and vendors — even if they're not in HR syste.</p>
        </div>
