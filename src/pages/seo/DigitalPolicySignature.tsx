...
export default function DigitalPolicySignature() {
  return (
    <div className="min-h-screen bg-background">
      <PageSEO
        title="Digital Policy Signature Software | Attestly"
          ...
          <div className="container">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Attestly is digital policy signature software for internal compliance use. Collect legally defensible signatures from employees, contractors, and vendors — without requiring them to create accounts, remember passwords, or download apps.
              </p>
