...
export default function PolicyAcknowledgment() {
  return (
    <div className="min-h-screen bg-background">
      <PageSEO
        title="Policy Acknowledgment Software | Attestly"
          ...
          <div className="container">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Attestly is policy acknowledgment software that allows businesses to send digital policies to employees or contractors and track legally defensible acknowledgment. Eliminate manual tracking and get timestamped proof with exportable records.
              </p>
          ...
          <div className="container">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="text-muted-foreground mb-8">
                Attestly makes this effortless with one-click signing links, automated reminders, and audit-ready exports — all without requiring recipients to create accounts.
              </p>

              <h2 className="text-2xl font-bold text-foreground mb-6">How Attestly tracks acknowledgments</h2>
